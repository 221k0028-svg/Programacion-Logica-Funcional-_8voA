...
agregar la variedad de cafe.

Dedemos modificar ordenar_cafe para que acepte una función como parámetro y así poder cambiar el tipo
...
1.- Crea una función preparar cafe que no recibe parámetros y devuelve una cadena que representa una
taza de café americano.
2.- Crea otra esta función devuelve una cadena que representa una taza de café olla.
3.- Crea otra función ordenar cafe que acepta dos parámetros: una función que prepara café y numero
de tazas.
4.- Dentro de la función ordenar crea una lista que guarde las tazas de cafe.
5.- Dentro de la función ordenar, aplica la iteración a través de la lista por comprensión para
llamar a la función preparar_cafe según el numero_tazas proporcionado.
6.- Finalmente en la función ordenar, devuelve la lista tazas_cafe.
5.- Crear una variable cafe para el grupo A que recibe el numero de tazas que prefieren el sabor
americano.
6.- Crear una variable cafe para el grupo B que recibe el numero de tazas que prefieren el sabor de
olla.
