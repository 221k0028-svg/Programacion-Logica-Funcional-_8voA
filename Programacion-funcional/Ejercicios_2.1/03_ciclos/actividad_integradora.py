...
#    R: Significa que una función se puede usar como si 
#       fuera cualquier otro dato, como un número o una cadena
#
# 2. ¿Cuál es la diferencia entre una función de orden superior y un callback?
#    R: Una función de orden superior es la que recibe o devuelve funciones, mientras 
#    que un callback es la función que se pasa como argumento para ser ejecutada
#
# 3. ¿Cuándo conviene usar comprensión de listas en lugar de un ciclo for?
#    R: La comprensión de listas conviene cuando la operación es simple y mejora la legibilidad; 
#    en cambio, un ciclo for es mejor cuando la lógica es más compleja o difícil de leer en una 
#    sola línea.
#
# 4. ¿Qué hace map() y cómo se relaciona con lambda?
#    R: La función map() aplica una función a cada elemento de una colección, y lambda 
#    permite definir esa función de forma anónima y en una sola línea.”
#
# 5. ¿Qué ventaja ofrece pasar una función como argumento a otra función?
#    R: La ventaja es que permite crear funciones más generales y reutilizables, 
#    ya que pueden cambiar su comportamiento según la función que reciben como argumento.
# 
...
#             - (preparar_alimento) como argumento.

#      - ¿Dónde usarás comprensión de listas?
#          R =
#            - Dentro de la función tomar_orden() para crear la lista de porciones,
#              repitiendo el alimento según la cantidad solicitada.   

#      - ¿Dónde usarás lambda + map()?
#          R = 
#           - Dentro de la función tomar_orden(), para generar la lista de precios,
#             aplicando el precio_unitario a cada porció
...
#   - Si no coincide, ¿en qué función está el error? No marco ningun error
#   - ¿Qué cambiarías para corregirlo? No es necesario realizar cambios, ya que el programa funciona correctamente
...
# Mostrar totales usando la función creada
total_pizza = calcular_total(precios_pizza)
total_agua  = calcular_total(precios_agua)
total_tamal = calcular_total(precios_tamal)
